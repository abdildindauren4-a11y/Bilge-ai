...
export const GamesView: React.FC<GamesViewProps> = ({ 
  isApiOk, onOpenApiModal, activeGame, setActiveGame, loading, setLoading, gameData, setGameData, params, setParams, addNotification,
  onGenerate, loadingMessage = 'Ойын жасалуда...'
}) => {
  ...
  const useTemplateWithTopic = async () => {
    ...
    if (!isApiOk) return onOpenApiModal();
  ...
  const saveCurrentGame = async () => {
    ...
    try {
      ...
      console.error(err);
      addNotification('Қате', 'Сақтау мүмкін болмады.', 'error');
    }
  };
          ...
          <div className="card card-pad">
              ...
              <div className="bg-orange-50 dark:bg-orange-900/20 border border-orange-200 dark:border-orange-800 rounded-2xl p-4 mb-6 flex items-center justify-between">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-xs text-orange-700 dark:text-orange-300">Ойындар жасау үшін Gemini API кілтін енгізіңіз.</p>
                  </div>
                </div>
            ...
            <div className="space-y-4">
              ...
              <button className="btn btn-primary btn-wide" onClick={handleGenerate} disabled={loading}>
                {loading ? 'Жасалуда...' : 'Ойынды бастау'}
              </button>
            </div>
          </div>
